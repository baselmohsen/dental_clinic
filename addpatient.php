...
if($_SERVER['REQUEST_METHOD']=='POST'){
  ...
  do{
    ...
    insert into patients(id,name, phone, address,birth_date,gender,doctor_id,appointment,service_id)
    
    values (?, ?, ?,?,?,?,?,?,?)
    
    ');
    
    mysqli_stmt_bind_param($stmt, 'isssssiss',$id, $name, $phone, $address,$birth_date,$gender,$doctor_id,$appointment,$service_id);
...
<br>
    <div class="form-group">
     ...
     <br>
      ...
      <input type="submit" name="add_patient" class="btn btn-success" value="save ">
      </div>
